...
The Kasper part was passed down to me from my Dad, though there are some pretty interesting facts about the [family's lineage](http://www.houseofnames.com/xq/asp.familycrest_details/s.Kasper/Kasper_family_Crest/Kasper_coat_of_arms/qx/Kasper.htm).

The 'vanRijn' part is something that happened on the way between then and now, but you can [read more about that later](/2002/02/02/allow-me-to-introduce-myself/).
...
The common thread is that I love having fun with my family, friends, and co-workers — unexpected snowball fights, lengthy video-game sessions, random [Airzooka missions](http://blogs.msdn.com/tristank/archive/2004/12/07/275579.aspx), late-night raids that go later than they should. Through all of it, I shall strive to not lose the boy inside for the man that is seen going to work everyday.

If you'd like to say hi, [vR@movingparts.net](mailto:vR@movingparts.net) is the best way.
