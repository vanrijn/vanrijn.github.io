---
layout: post
title: KDE 4.2 and KPilot Status
date: 2008-08-05 12:29:01.000000000 -07:00
published: true
categories:
- Life in General
tags: []
permalink: "/2008/08/05/kde-42-and-kpilot-status/"
---

[Bertjan has already done a very nice job](http://bertjan.broeksemaatjes.nl/node/39) of giving an overview of where we are with [this year's GSOC project](http://tinyurl.com/6gqlf6) and where KPilot is in general. I wanted to add a couple of things to this train of thought too...

First off, this is the second year that I've worked with Bertjan on a Google Summer of Code project and I have thoroughly enjoyed both years. Last year, our goal was to create a base conduit framework that could be used to unify KPilot's conduit code and push down into it all of the synchronization logic that was previously spread across all of the individual conduits. This was a success, and Bertjan also wrote a new [Keyring](http://gnukeyring.sourceforge.net/) conduit that implemented the new base conduit infrastructure. Unfortunately, these were dark days for KPilot and neither Bertjan nor I nor Adriaan had any more time to give to our little KPilot friend. KPilot was semi-ported to Qt4/KDE4, but none of our KDE PIM conduits worked. And so KPilot languished pretty much untouched and unloved between last year's GSOC project and this.
